...
func (app *application) editConflictValidation(w http.ResponseWriter, r *http.Request) {
	message := fmt.Sprintf("Unable to update the record due to an edit conflict. Please try again")
